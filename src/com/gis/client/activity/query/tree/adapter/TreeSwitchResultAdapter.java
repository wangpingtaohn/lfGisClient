...
public class TreeSwitchResultAdapter extends BaseAdapter {
	...
	private void setValue(TextView view, int position) {
		...
		case 0:
			...
			break;
		case 1:
			view.setText(mResult.getFtuNumber() + "");
			break;
		case 2:
		...
		case 12:
			...
			break;
		case 13:
			view.setText(mResult.getOrganizationNumber() + "");
			break;
		case 14:
			view.setText(mResult.getMadeNumber() + "");
			break;
		case 15:
			view.setText(mResult.getRatedVatige() + "");
			break;
		case 16:
			view.setText(mResult.getElectricityValue() + "");
			break;
		case 17:
			view.setText(mResult.getSpeedValue() + "");
			break;
		case 18:
			view.setText(mResult.getIntTime() + "");
			break;
		case 19:
			view.setText(mResult.getAngle() + "°");
			break;
		case 20:
			view.setText(mResult.getMadeDate());
			break;
		default:
			break;
		}
